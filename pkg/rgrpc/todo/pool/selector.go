...
// SpacesSelector returns a Selector[storageProvider.SpacesAPIClient].
func SpacesSelector(id string, options ...Option) (*Selector[storageProvider.SpacesAPIClient], error) {
